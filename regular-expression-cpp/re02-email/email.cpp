...
{
	std::string email;
	std::regex pattern("[a-zA-Z0-9_\.]+@[a-zA-Z]+\.[a-zA-Z]+(\.[a-zA-Z]+)*");

	std::cout << "Enter your test email: ";
...
/*
** Cú pháp: Cú pháp: Tên Email + @ + Tên miền
- Tên Email: Ký tự hoa, ký tự thường, chữ số, dấu gạch dưới, và dấu chấm => Gom thành một nhóm: [a-zA-Z0-9_\.]
- Ký tự @
- Tên miền: Ký tự hoa, ký tự thường, có dấu chấm để phân cách
 + [a-zA-Z]+\.[a-zA-Z]: chỉ hợp lệ với: gmail.com, yahoo.com. outlook.com,.. Còn các tên miền như: outlook.com.vn, yahoo.com.vn,..
