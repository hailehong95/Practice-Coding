...
// Phương thức Nhập sinh viên từ bàn phím
void SinhVien::NhapSinhVien() {
	...
	// Lặp lại nếu nhập sai giới tính
	do {
		cout << "\nNhap Gioi tinh (1-3): ";
		cin >> Sex;
		if (Sex < 1 || Sex > 4)
	...
	// Lặp lại nếu nhập sai điểm toán
	do {
		cout << "\nNhap diem Toan (1-10): ";
		cin >> Toan;
		if (Toan < 0 || Toan > 10)
...
// Phương thức Tính tổng điểm 3 môn
