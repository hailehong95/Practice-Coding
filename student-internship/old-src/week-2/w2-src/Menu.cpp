...
void Menu::MenuChinh() {
	system("cls");
	cout << "CHUONG TRINH QUAN LY DIEM THI SINH VIEN 2016";
...
// Phương thức hiển thị Menu Xóa, Sửa, Thêm
...
// Phương thức hiển thị Menu Tìm kiếm sinh viên
...
// Phương thức hiển thị Menu Sắp xếp sinh viên
