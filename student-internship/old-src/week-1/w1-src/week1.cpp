...
int main()
{
	...
	while (true)
	{
		...
		{
			system("cls");
			cout << "QLDT DH 2016" << endl;
			cout << "1: Them - Sua - Xoa" << endl;
		...
		case 1:
		{
			...
			case 1:
			{
				...
				system("pause>null"); // clear:"Press any key to continue.."
				break;
			}
			case 2:
			{
		...
		case 3:
		{
			...
			{
				system("cls");
				cout << "SAP XEP DANH SACH SINH VIEN" << endl;
		...
		{
			GhiFile();
			// File output.txt cung thu muc file Source.cpp
...
f >> hoten >> sbd >> diachi >> gioitinh >> toan >> ly >> hoa;
}
f.close();
}
*/
