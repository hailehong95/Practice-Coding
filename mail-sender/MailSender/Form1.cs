    ...
    public partial class MailSender : Form
    {
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            Thread thread = new Thread(() =>
            {
                try
                {
                    ...
                    if (checkRD == false)
                    {
                        StreamReader strd = new StreamReader(@"List.txt");
        ...
        private void txbNhapMail_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                txbNhapMail.ReadOnly = true;
                System.IO.FileStream fs = new System.IO.FileStream(@"List.txt", FileMode.Create, FileAccess.Write, FileShare.None);
                ...
                /*
                // Đọc thử
                StreamReader strm = new StreamReader(@"List.txt");
                string strdoc;
