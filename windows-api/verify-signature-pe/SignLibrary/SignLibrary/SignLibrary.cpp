// SignLibrary.cpp : Defines the exported functions for the DLL.
...
#include <wincrypt.h>
#include <WinTrust.h>
#include "SignLibrary.h"

// Link with the Wintrust.lib file.
#pragma comment (lib, "wintrust")

unsigned int signed_check(LPCWSTR pwszSourceFile)
{
	LONG lStatus;
	DWORD dwLastError;
	...
	*/
	...
	case ERROR_SUCCESS:
		...
		*/
		...
		// break;
		return 1; // File signed, Signature verified
	...
	case CRYPT_E_SECURITY_SETTINGS:
		...
		*/
		...
		break;
		*/
		return 6; // Hash wasn't explicitly trusted
