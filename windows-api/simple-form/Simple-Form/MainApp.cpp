...
int APIENTRY wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
	...
	RegisterClass(&wc);
	CreateWindow(wc.lpszClassName, TEXT("::Student Manager::"), WS_OVERLAPPEDWINDOW | WS_VISIBLE, 300, 300, 650, 500, 0, 0, hInstance, 0);
