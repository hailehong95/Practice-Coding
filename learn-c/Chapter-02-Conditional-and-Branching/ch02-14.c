...
int main()
{
	...
	*/
	...
	if (Ngay == 31) {
		...
		if (Thang == 12) {
			// Xử lý riêng tháng 12 vì là tháng cuối năm
			printf("Ngay truoc do:\t %d/%d/%d\n", Ngay - 1, Thang, Nam);
			printf("Ngay ke tiep:\t %d/%d/%d\n", 1, 1, Nam + 1);
		}
		else {
			// Xử lý các tháng còn lại: 1, 3, 5, 7, 8, 10
			printf("Ngay truoc do:\t %d/%d/%d\n", Ngay - 1, Thang, Nam);
			printf("Ngay ke tiep:\t %d/%d/%d\n", 1, Thang + 1, Nam);
		}
	}
		...
		if (Thang == 4 || Thang == 6 || Thang == 9 || Thang == 11) {
			// Những tháng chỉ có 30 ngày: 4, 6, 9, 11
			printf("Ngay truoc do:\t %d/%d/%d\n", Ngay - 1, Thang, Nam);
			printf("Ngay ke tiep:\t %d/%d/%d\n", 1, Thang + 1, Nam);
		}
		else {
			// Những tháng còn lại: 1, 3, 5, 7, 8, 10, 12
			printf("Ngay truoc do:\t %d/%d/%d\n", Ngay - 1, Thang, Nam);
			printf("Ngay ke tiep:\t %d/%d/%d\n", Ngay + 1, Thang, Nam);
		}
	}
		...
		if (Thang == 1) {
			// Xử lý riêng tháng 1 vì là tháng đầu năm
			printf("Ngay truoc do:\t %d/%d/%d\n", 31, 12, Nam - 1);
			printf("Ngay ke tiep:\t %d/%d/%d\n", Ngay + 1, Thang, Nam);
		}
		...
		// Ngày 29 tháng 2 của năm nhuận
		printf("Ngay truoc do:\t %d/%d/%d\n", 28, Thang, Nam);
		printf("Ngay ke tiep:\t %d/%d/%d\n", 1, Thang + 1, Nam);
	}
	else if (Ngay == 28 && Thang == 2) {
		if ((Nam % 4 == 0 && Nam % 100 != 0) || Nam % 400 == 0) {
			// Ngày 28 tháng 2 của năm nhuận
			printf("Ngay truoc do:\t %d/%d/%d\n", Ngay - 1, Thang, Nam);
			printf("Ngay ke tiep:\t %d/%d/%d\n", Ngay + 1, Thang, Nam);
		}
		else {
			// Ngày 28 tháng 2 của các năm thường
			printf("Ngay truoc do:\t %d/%d/%d\n", 27, Thang, Nam);
			printf("Ngay ke tiep:\t %d/%d/%d\n", 1, Thang + 1, Nam);
		}
	}
